<div class="col-md-10 content">
	<br/>
	<button class="btn btn-success" id="view_modal_lihat_verifikasi_krs"><i class="fa fa-plus" aria-hidden="true"></i> Tambah</button>
    <br/><br/>
    <table class="table table-striped">
    	<tr><td>NPM</td><td>:</td><td><?=$biodata->npm?></td></tr>
        <tr><td>Nama</td><td>:</td><td><?=$biodata->nama_mhs?></td></tr>
        <tr><td>kelas</td><td>:</td><td><?=$biodata->nama_kelas?></td></tr>
    </table>
	<hr/>
	<br/>
