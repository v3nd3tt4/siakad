<div class="col-md-10 content">
	<br/>
	<button class="btn btn-success" id="view_modal_per_matkul"><i class="fa fa-plus" aria-hidden="true"></i> Tambah</button>
	<hr/>
	<br/>
	...
	<table class="table table-striped t">
		...
		?>
			<tr>
				...
				<td align="center">
					<a href="#" data-toggle="tooltip" data-placement="bottom" title="Hapus" id="<?=$data->per_id?>" class="hapus_per_matkul" style="color:red"><i class="fa fa-trash" aria-hidden="true"></i>
					</a> | 
					<a href="#" data-toggle="tooltip" data-placement="bottom" title="Edit" id="<?=$data->per_id?>" class="edit_per_matkul" style="color:green"><i class="fa fa-pencil" aria-hidden="true"></i>
					</a> <!--| 
